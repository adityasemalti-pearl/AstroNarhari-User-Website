...
const Cart = () => {
  ...
  const discount = cartItems.reduce(
    (total, item) =>
      total + (item.product?.price - item.product?.salePrice) * item.quantity,
    0,
  );
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <div className="mt-8 flex flex-wrap items-center justify-between gap-5">
                        ...
                        <button
                          ...
                          className="flex items-center gap-2 rounded-2xl bg-red-50 px-5 py-3 font-semibold text-red-600 transition hover:bg-red-100 disabled:opacity-50"
                        >
                          <Trash2 size={18} />
                          Remove
                        </button>
          ...
          <div>
            <div className="sticky top-24 space-y-6">
              ...
              <div className="overflow-hidden rounded-[32px] border border-purple-100 bg-white shadow-xl">
                ...
                <div className="space-y-5 p-7">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-bold text-purple-950">₹{gst}</span>
                  </div>
              ...
              <div className="rounded-[32px] bg-gradient-to-r from-purple-900 to-indigo-900 p-7 text-white shadow-xl">
                ...
                <h2 className="mt-2 text-4xl font-black">2 - 4 Days</h2>
          ...
          <div className="w-full max-w-sm rounded-3xl bg-white p-7 shadow-2xl">
            ...
            <div className="mt-7 flex gap-3">
              <button
                ...
                className="flex-1 rounded-xl border border-purple-200 bg-white py-3 font-semibold text-purple-900 transition hover:bg-purple-50"
              >
                Cancel
              </button>
              ...
              >
                {deletingProductId ? (
                  <div className="mx-auto h-5 w-5 animate-spin rounded-full border-2 border-white/40 border-t-white"></div>
                ) : (
                  "Remove"
                )}
              </button>
