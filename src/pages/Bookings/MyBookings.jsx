                  ...
                  {upcomingBookings.map((booking) => (
                    <UpcomingBooking
                      ...
                      astrologer={{
                        ...
                        specialties: booking.partner?.specialties || [],
                        minRate: booking.partner?.minRate || 0,
                      }}
                      booking={{
                        id: booking._id,
                      ...
                      onJoin={() => console.log("Join Booking:", booking)}
                      onReschedule={() => console.log("Reschedule:", booking)}
                ...
                <div className="space-y-5">
                  {pastBookings.map((booking) => (
                    <PastBookings
                      ...
                      onBookAgain={() => console.log("Book Again:", booking)}
                    />
                  ))}
                </div>
              )}
