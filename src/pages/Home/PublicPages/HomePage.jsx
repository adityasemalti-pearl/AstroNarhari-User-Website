...
import { getblogs } from "../../../API/homeApis";
    ...
    <div className="asx-root">
      ...
      <section className="hero" id="hero">
        ...
        <div
          ...
          style={{
            ...
            top: "14%",
            left: "6%",
            background: "radial-gradient(circle at 35% 30%, #E8CE7E, #7a5c10)",
          }}
        />
        <div
          className="planet"
          style={{
            ...
            top: "68%",
            left: "12%",
            background: "radial-gradient(circle at 35% 30%, #C9AEFB, #4C1D95)",
            animationDelay: "1.4s",
          }}
        />
        ...
        <div className="wrap hero-grid">
          <div>
            <div className="live-badge">
              <span className="pulse-dot" /> {liveCount} astrologers online
              right now
            </div>
            <h1>
            ...
            <p className="lead">
              Get instant clarity on love, career, marriage & life through live
              call or chat with 500+ verified Vedic astrologers — private,
          ...
          <div className="phone-stage">
            <div className="float-chip chip-live">
              <span className="dot" /> Pt. Ramesh is online
            </div>
            ...
            <div className="phone">
              ...
              <div className="phone-screen">
                ...
                >
                  Namaste 🙏 I see strong Jupiter influence in your 7th house
                  this month.
                </div>
                <div
                ...
                >
                  That explains a lot! What about my career?
                </div>
                <div
                  className="chat-bubble them"
                  style={{ animationDelay: "1s" }}
                >
                  Saturn transit favours new opportunities after the 14th ✨
                </div>
                <div
                  className="phone-card"
                  style={{ animation: "bubbleIn .6s ease 1.4s both" }}
                >
                  <div className="ic">🔮</div>
                  <div>
                    <div className="t">Free Kundli Match</div>
                    <div className="s">Check compatibility instantly</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="section" id="services">
        <div className="wrap">
          <Reveal className="section-head">
            ...
            <p>
              From daily guidance to deep life predictions — everything rooted
              in authentic Vedic astrology.
            </p>
          </Reveal>
      ...
      <section className="section alt" id="astrologers">
        <div className="wrap">
          <Reveal className="section-head">
            ...
            <p>
              Every astrologer is background-verified and rated by thousands of
              real users.
            </p>
          </Reveal>
          <Reveal stagger className="astro-grid">
            {ASTROLOGERS.map((a) => (
              <div className="astro-card" key={a.name}>
                ...
                <a href="/dashboard/astrologers" className="btn btn-primary">
                  Talk Now
                </a>
              </div>
            ))}
          ...
          <div style={{ textAlign: "center", marginTop: 44 }}>
            <a href="/dashboard/astrologers" className="btn btn-outline">
              View All 500+ Astrologers
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="section alt" id="testimonials">
        <div className="wrap">
          ...
          <Reveal className="testi-wrap" style={{ position: "relative" }}>
            <div
          ...
          <Reveal className="appscreens-track">
            <div className="mini-phone">
              <div className="mini-screen">
                ...
                <div className="phone-card" style={{ margin: "0 0 10px" }}>
                  <div className="ic">🔮</div>
                  <div>
                    <div className="t">Kundli</div>
                    <div className="s">View chart</div>
                  </div>
                </div>
                <div className="phone-card" style={{ margin: "0 0 10px" }}>
                  <div className="ic">📅</div>
                  <div>
                    <div className="t">Horoscope</div>
                ...
                <div className="phone-card">
                  ...
                  <div>
                    ...
                    <div className="s">₹450 balance</div>
                  </div>
                </div>
            ...
            <div className="mini-phone">
              <div className="mini-screen">
                <div className="chat-bubble them" style={{ margin: "0 0 8px" }}>
                  Your 2nd house shows financial growth soon 💫
                </div>
                <div
                  className="chat-bubble me"
                  style={{ margin: "0 0 0 auto" }}
                >
                  Thank you! Any remedies?
                </div>
            ...
            <div className="mini-phone">
              <div className="mini-screen">
                ...
                >
                  A favourable day for bold decisions. Trust your instincts in
                  matters of career and love.
                </p>
            ...
            <div className="mini-phone">
              <div className="mini-screen">
                ...
                <div className="phone-card" style={{ marginTop: 16 }}>
                  <div className="ic">➕</div>
                  <div>
                    <div className="t">Add Money</div>
                    <div className="s">Instant recharge</div>
                  </div>
                </div>
      ...
      {/* <section className="section" id="pricing">
        <div className="wrap">
          <Reveal className="section-head">
            ...
            <p>
              Pay only for what you use. Bigger recharges unlock bonus
              talk-time.
            </p>
          </Reveal>
        ...
        <div className="wrap">
          <Reveal className="download-panel">
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p>
                Download the Namah-Astro app for faster consultations, push
                notifications for daily horoscope, and exclusive app-only
                offers.
              </p>
      ...
      <section className="newsletter">
        <div className="wrap">
          ...
          <h2 style={{ marginTop: 14 }}>
            Weekly cosmic insights in your inbox
          </h2>
        ...
        <div className="wrap" style={{ position: "relative", zIndex: 1 }}>
          <div className="footer-grid">
            <div className="footer-brand">
              <a href="#hero" className="logo" style={{ color: "#fff" }}>
                <span className="glyph">✦</span>Namah-Astro
              </a>
              <p>
                India's most trusted platform to connect with verified
                astrologers for live call & chat consultations.
              </p>
            ...
            <div className="footer-col">
              ...
              <ul>
                <li>
                  <a href="#services">Kundli</a>
                </li>
                <li>
                  <a href="#services">Match Making</a>
                </li>
                <li>
                  <a href="#astrologers">Talk to Astrologer</a>
                </li>
                <li>
                  <a href="#services">Numerology</a>
                </li>
              </ul>
            </div>
            <div className="footer-col">
              ...
              <ul>
                ...
                <li>+91 9520401700</li>
                <li>
                  705, D36, A Lohiya Apartment, Building No.3, Mehrauli, New
                  Delhi
                </li>
              </ul>
            </div>
