...
const SERVICES = [
  { icon: "🔮", title: "Kundli", desc: "Detailed birth chart analysis" },
  { icon: "❤️", title: "Match Making", desc: "Guna milan & compatibility" },
  { icon: "📞", title: "Talk to Astrologer", desc: "Live voice consultation" },
  { icon: "💬", title: "Chat Consultation", desc: "Private, instant chat" },
  { icon: "📅", title: "Daily Horoscope", desc: "Personalised daily insights" },
  { icon: "🎉", title: "Festival Calendar", desc: "Auspicious dates & muhurat" },
  { icon: "🪐", title: "Numerology", desc: "Numbers that shape your life" },
  { icon: "🕉️", title: "Vastu", desc: "Harmony for home & office" },
  { icon: "💎", title: "Gemstone", desc: "Remedies & recommendations" },
  { icon: "📖", title: "Panchang", desc: "Daily Hindu almanac" },
];
...
const WHY = [
  { icon: "✔", title: "Verified Experts", desc: "Every astrologer passes a rigorous background & skill verification before onboarding." },
  { icon: "⚡", title: "Instant Consultation", desc: "Connect within seconds — no waiting rooms, no scheduling hassle." },
  { icon: "🔒", title: "Secure Payments", desc: "100% encrypted transactions with trusted payment partners." },
  { icon: "🛡️", title: "Privacy Protected", desc: "Your identity and conversations stay completely confidential." },
  { icon: "🎯", title: "Accurate Predictions", desc: "Rooted in authentic Vedic principles, refined over decades of practice." },
  { icon: "🕐", title: "24×7 Support", desc: "Our care team and astrologers are available around the clock, every day." },
];
      ...
      <header className={scrolled ? "scrolled" : ""}>
        <div className="wrap nav-row ">
          <a href="#hero" className="logo">
            <img src={logo} alt="logo" className="h-12" />Namah-Astro
          </a>
          ...
          <div className="nav-cta">
            {/* <a href="/login" className="btn btn-outline">Chat Now</a> */}
            <a href="#app" className="btn btn-primary">Get App</a>
          </div>
        ...
        <div className="wrap hero-grid">
          <div>
            ...
            <div className="hero-ctas">
              ...
              <a href="/login" className="btn btn-ghost">💬 Chat Now</a>
            </div>
        ...
        <div className="wrap">
          ...
          <Reveal className="kundli-panel">
            <div className="kundli-form">
              ...
              <a href="#" className="btn btn-primary" style={{ width: "100%", marginTop: 8 }}>Generate My Kundli</a>
            </div>
