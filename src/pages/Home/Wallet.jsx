...
import { myWallet, addMoneyToWallet } from "../../API/bookingApis";
...
export default function WalletPage({ onBack }) {
  ...
  const handleRecharge = async () => {
    try {
      ...
      console.log("=================================");
      console.log("Wallet Amount:", amountInRupees);
      ...
      const options = {
        ...
        handler: async function (paymentResponse) {
          ...
          try {
            // ======================================
            // IMPORTANT:
            // Backend wallet API receives RUPEES
            // NOT PAISE
            // ======================================
            ...
            console.log("Calling addMoneyToWallet:", payload);
            ...
            if (response?.data?.success === false) {
              alert(response?.data?.message || "Unable to add money.");
              return;
            }

            if (response?.success === false) {
              alert(response?.message || "Unable to add money.");
              return;
            }
      ...
      if (!window.Razorpay) {
        alert("Razorpay SDK is not loaded. Add Razorpay script to index.html.");
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-6 overflow-hidden rounded-2xl bg-purple-700 p-6 text-white shadow-lg">
          ...
          <div className="mt-6 flex items-center justify-between border-t border-white/15 pt-4">
            <span className="text-xs text-purple-200">Secure wallet</span>
        ...
        <div className="mt-6 rounded-2xl bg-white p-5 shadow-sm">
          ...
          <div className="rounded-xl border border-dashed border-gray-200 py-10 text-center">
            <Wallet size={28} className="mx-auto text-gray-300" />
